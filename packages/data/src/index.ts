...
class PhotoLoader {
  ...
  constructor() {
    ...
    this.photos = window.__MANIFEST__.data as unknown as PhotoManifestItem[]
    this.cameras = window.__MANIFEST__.cameras as unknown as CameraInfo[]
    this.lenses = window.__MANIFEST__.lenses as unknown as LensInfo[]
